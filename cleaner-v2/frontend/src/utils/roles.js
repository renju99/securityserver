export const ROLE_OPTIONS = [
    { value: 'cleaner', label: 'Cleaner', description: 'Check-in at washrooms, complete checklists' },
    ...
    { value: 'admin', label: 'Full Admin', description: 'Full access: projects, washrooms, users, all settings' },
];
