# -*- coding: utf-8 -*-
"""Post-migration script for GuardLink 18.0.1.0.2
...
def migrate(cr, version):
    ...
    _logger.info("Running GuardLink post-migration 18.0.1.0.2")
    ...
    _logger.info("GuardLink post-migration 18.0.1.0.2 completed successfully")
